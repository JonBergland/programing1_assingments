...
class oving2Oppgave1{
    public static void main(String[] args) {
        ...
        int aar = Integer.valueOf(brukerInput);
        boolean skuddAar = false;

        // svar = sjekkOmSkuddaar(aar, skuddAar);
        final String svar = sjekkOmSkuddaar(aar, skuddAar)
            ? " er et skuddår!"
            : " er ikke et skuddår";

        System.out.println(aar +""+ svar);
    ...
    public static boolean sjekkOmSkuddaar(int aar, boolean skuddAar) {
        if (aar%400 == 0 && aar != 0){
           skuddAar = true;
        } else if (aar%4 == 0 && aar%100 != 0 && aar != 0) {
            skuddAar = true;
        }
        return skuddAar;
